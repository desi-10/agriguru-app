    ...
    <View style={styles.container}>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => {
            router.push({
              pathname: "/admin/(tabs)/dashboard/farmerDetail",
              params: {
                id: produce?.farmer?.user,
              },
            });
          }}
        >
        ...
        {user?.role !== "admin" && produce?.farmer.id === user?.farmer_id && (
          <TouchableOpacity
            onPress={() => {
              router.push({
                pathname: "/admin/(tabs)/dashboard/ProduceEdit",
                params: {
                  id: id,
                },
              });
